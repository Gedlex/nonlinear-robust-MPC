function [params, obs] = PQRparams_theta_half()
% PQRPARAMS_THETA_HALF initializes a struct containing the controller parameters
% for a planar quadrotor.
    ...
    params.theta_v = 0.5*2.0576*[-0.01, 0.01];
